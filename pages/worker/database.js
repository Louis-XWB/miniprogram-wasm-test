...
["_malloc","_free","_sqlite3_open","_sqlite3_exec","_sqlite3_close","_db_sysconf_env_init","_db_set_loop_sensor","_db_get_loop_sensor","_memory","___indirect_function_table","onRuntimeInitialized"].forEach((prop) => {
...
function instantiateArrayBuffer(binaryFile, imports, receiver) {
  ...
  return WebAssembly.instantiate('/workers/database.wasm', imports)
...
var _db_get_loop_sensor = Module['_db_get_loop_sensor'] = createExportWrapper('db_get_loop_sensor', 2);
var _db_set_loop_sensor = Module['_db_set_loop_sensor'] = createExportWrapper('db_set_loop_sensor', 2);
...
var _db_sysconf_env_init = Module['_db_sysconf_env_init'] = createExportWrapper('db_sysconf_env_init', 2);
